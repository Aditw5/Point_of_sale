...
<body onload="window.print()">
    ...
    <table width="100%" style="border: 0;">
        @foreach ($detail as $item)
            ...
            <tr>
                <td>{{ $item->amount }} x {{ format_uang($item->sell_price) }}</td>
                <td></td>
                <td class="text-right">{{ format_uang($item->amount * $item->sell_price) }}</td>
            </tr>
        @endforeach
    </table>
    <p class="text-center">-----------------------------------</p>
    ...
    <table width="100%" style="border: 0;">
        ...
        <tr>
            <td>Discont:</td>
            <td class="text-right">{{ format_uang($sale->discont) }}</td>
        </tr>
        <tr>
            <td>Total Pay:</td>
